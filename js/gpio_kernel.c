...
static unsigned int gpioLED = 97;       ///< setting the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 98;   ///< setting the button gpio for this example to P9_27 (GPIO115)
...
static int __init ebbgpio_init(void){
   ...
   result = request_irq(irqNumber,             // The interrupt number requested
                        ...
                        IRQF_TRIGGER_FALLING | IRQF_TRIGGER_RISING,   // Interrupt on rising or falling edge
